...
- 图片占位符格式：\`[图片: 简短关键词]\`
- **关键词要求**：2-5个字的简短词语，便于搜索
- ❌ 错误（太长太复杂）：\`[图片: 深夜雨中，一位外卖骑手骑着电动车疾驰在空旷的街道上]\`
- ✅ 正确（简短关键词）：\`[图片: 外卖骑手]\`、\`[图片: 深夜送餐]\`、\`[图片: 雨中骑行]\`
- 更多示例：
  - \`[图片: 高速公路]\`、\`[图片: 交通事故]\`、\`[图片: 救护车]\`
  - \`[图片: 咖啡厅]\`、\`[图片: 年轻女孩]\`、\`[图片: 看手机]\`
  - \`[图片: 办公室]\`、\`[图片: 加班]\`、\`[图片: 电脑工作]\`
...
- 图片占位符格式：\`[图片: 简短关键词]\`
- **关键词要求**：2-5个字的简短词语，便于搜索
- ❌ 错误（太长太复杂）：\`[图片: 年轻程序员坐在电脑前，屏幕上显示着代码，旁边放着咖啡]\`
- ✅ 正确（简短关键词）：\`[图片: 程序员]\`、\`[图片: 写代码]\`、\`[图片: 办公室]\`
- 更多示例：
  - \`[图片: 数据分析]\`、\`[图片: 图表]\`、\`[图片: 统计数据]\`
  - \`[图片: 互联网公司]\`、\`[图片: 会议室]\`、\`[图片: 团队协作]\`
  - \`[图片: 书籍]\`、\`[图片: 学习]\`、\`[图片: 笔记本]\`
